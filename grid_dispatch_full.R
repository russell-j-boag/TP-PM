...
save(samples, file = "samples/sTPPM_full.RData")
...
# Save samples
save(samples, samples1, file = "samples/sTPPM_full.RData")
...
#                       report = 10)
# # Save samples
# save(samples, samples1, samples2, file = "samples/sTPPM_full.RData")
